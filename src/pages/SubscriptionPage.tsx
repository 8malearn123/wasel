...
const PLAN_CONTENT: Record<string, {
  ...
  Enterprise: {
    ...
    features: [
      ...
      'تقارير متقدمة للمبيعات والأرباح لكل فرع',
      'كوبونات وحملات تسويقية ونقاط ولاء',
      'تحويلات مخزون بين الفروع وجرد دوري متقدم',
  ...
  Distributor: {
    ...
    features: [
      ...
      'استوديو تصميم كامل للمتجر (قوالب، ألوان، خطوط)',
