          ...
          <ResponsiveContainer width="100%" height="100%">
            {chartType === "area" ? (
              <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                <defs>
                  <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="hsl(185, 70%, 28%)" stopOpacity={0.3} />
                    <stop offset="95%" stopColor="hsl(185, 70%, 28%)" stopOpacity={0} />
                  </linearGradient>
                ...
                />
                <Area type="monotone" dataKey="revenue" stroke="hsl(185, 70%, 28%)" strokeWidth={2} fillOpacity={1} fill="url(#colorRevenue)" />
              ...
              <BarChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                ...
                />
                <Bar dataKey="revenue" fill="hsl(185, 70%, 28%)" radius={[4, 4, 0, 0]} />
